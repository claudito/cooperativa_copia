...
<div class="table-responsive">
	<table class="table table-bordered table-condensed">
		...
		<tbody>
		<?php
		$socio_puesto = new Socio_puesto($id); 
		foreach ($socio_puesto->lista() as $key => $value): ?>
		<tr>
				<td>
...
<?php include'../../modal/socio/puesto_eliminar.php'; ?>
<script>
...
$( "#eliminar_puesto" ).submit(function( event ) {
    var parametros = $(this).serialize();
       $.ajax({
          type: "POST",
          url: "../controlador/socio/puesto_eliminar.php",
          data: parametros,
           beforeSend: function(objeto){
            $("#mensaje").html("Mensaje: Cargando...");
            },
