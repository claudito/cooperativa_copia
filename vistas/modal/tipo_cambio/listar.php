...
include'../../../session.php';
 ...
 <?php if (count(Tipo_cambio::lista())>0): ?>
<div class="panel panel-info">
	<div class="panel-heading">
	<h3 class="panel-title">TIPO DE CAMBIO DÓLAR</h3>
	...
	<table id="consulta"  class="table table-bordered table-condensed">
		...
		<tbody>
	    <?php 
	    foreach (Tipo_cambio::lista() as $key => $value): ?>
	    <tr>
	    <td><?php echo date_format(date_create($value['fecha']),'d/m/Y'); ?></td>
	    <td><?php echo $value['compra'] ?></td>
        ...
        <button class="btn btn-danger btn-sm" data-toggle="modal"
         ...
         data-id="<?php echo $value['id']; ?>"
         data-nombres="<?php echo $value['id']; ?>"
 ...
 <!-- Script Modal Actualizar -->
   <script>
  	$(".btn-edit").click(function(){
  		id = $(this).data("id");
  		$.get("../vistas/modal/tipo_cambio/actualizar.php","id="+id,function(data){
  			$("#form-edit").html(data);
  		});
