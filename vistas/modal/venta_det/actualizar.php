...
<input type="number" name="cantidad"  class="form-control"  required=""  value="<?php echo round($objeto->consulta($id,'cantidad'),2); ?>">
</div>
</div>
...
<input type="number" step="any" name="precio_uni"  class="form-control"  required=""  value="<?php echo round($objeto->consulta($id,'precio_unitario'),2); ?>">
</div>
</div>
