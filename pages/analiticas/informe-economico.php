...
include'../../session.php';
Assets::principal('Informe Económico');
Assets::datatables();
Assets::sweetalert();
Html::header();
Html::nav('../..'); #barra de navegación
Html::breadcrumbs('ANALÍTICAS','INFORME ECONÓMICO'); #cinta de ubicación
?>
...
<script src="../../ajax/analitica/informe-economico.js"></script>
