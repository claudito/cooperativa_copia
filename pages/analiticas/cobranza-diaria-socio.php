...
include'../../session.php';
Assets::principal('Cobranza Diara Socio');
Assets::datatables();
Assets::sweetalert();
Html::header();
Html::nav('../..'); #barra de navegación
Html::breadcrumbs('ANALÍTICAS','COBRANZA DIARIA SOCIO'); #cinta de ubicación
?>
...
<script src="../../ajax/analitica/cobranza-diaria-socio.js"></script>
