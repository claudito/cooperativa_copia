...
include'../../session.php';
Assets::principal('Registro de Compras');
Assets::datatables();
Assets::sweetalert();
Html::header();
Html::nav('../..'); #barra de navegación
Html::breadcrumbs('ANALÍTICAS','REGISTRO DE COMPRAS'); #cinta de ubicación
?>
...
<script src="../../ajax/analitica/registro-compras.js"></script>
